...
<html lang="en">
   ...
   <!-- ==== body starts ==== -->
    <body id="top">
        ...
        <!-- page wrapper starts -->
        <div id="page-wrapper">
            <div class="register-lead-desktop">
                <form id="regform" method="POST" action="leadform">
                    
                    {{ csrf_field() }}
                    <div class="form-group mt-3">
                        <input type="text" class="form-control" id="" name="studentName" placeholder="Enter Name of Your Child">
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-7">
                            <input type="number" name="studentMobile" class="form-control" id="" placeholder="Enter Mobile Number" maxlength="10" onkeydown="return event.keyCode !== 69" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required>
                        </div>
            ...
            <div class="container-fluid p-0">
                ...
                <div class="slider">
                    <!-- Slide 0 -->
                    <div class="slide slide-0 active" style="background-image:{{url('assets/img/slider/slide1.jpg')}}">
                    ...
                    <!-- Slide 1 -->
                    <div class="slide slide-1" style="background-image:{{url('assets/img/slider/slide2.jpg')}}">
                        <div class="slide__bg"></div>
                        <div class="slide__content">
                            <svg class="slide__overlay" viewBox="0 0 720 405" preserveAspectRatio="xMaxYMax slice">
                                <path class="slide__overlay-path" d="M0,0 150,0 500,405 0,405" />
                    ...
                    <!-- Slide 2 -->
                    <div class="slide slide-2" style="background-image:{{url('assets/img/slider/slide3.jpg')}}">
                        <div class="slide__bg"></div>
                        <div class="slide__content">
                            <svg class="slide__overlay" viewBox="0 0 720 405" preserveAspectRatio="xMaxYMax slice">
                            <path class="slide__overlay-path" d="M0,0 150,0 500,405 0,405" />
                ...
                <div class="col-lg-4" data-aos="zoom-out">
                    <div class="card card-flip">
                        ...
                        <div class="card bg-secondary text-light ">
                            ...
                            <!-- /p-5 -->
                            <!-- image -->
                            <img class="card-img" src="{{url('assets/img/intro1.jpg')}} " alt="">
                        </div>
                        <!-- /card -->
                        <!-- back of card -->  			
                ...
                <div class="col-lg-4" data-aos="zoom-out" data-aos-delay="300">
                    <div class="card card-flip ">
                        ...
                        <div class="card bg-primary text-light">
                            ...
                            <!-- /p-5 -->
                            <!-- image -->
                            <img class="card-img" src="{{url('assets/img/intro2.jpg')}}" alt="">
                        </div>
                        <!-- /card -->
                        <!-- back of card -->  			
                ...
                <div class="col-lg-4" data-aos="zoom-out" data-aos-delay="600">
                    <div class="card card-flip ">
                        ...
                        <div class="card bg-tertiary text-light">
                            ...
                            <!-- /p-5 -->
                            <!-- image -->
                            <img class="card-img" src="{{url('assets/img/intro3.jpg')}}" alt="">
                        </div>
                        <!-- /card -->
                        <!-- back of card -->  			
            ...
            <section id="about-home" class="container-fluid pb-0">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 res-margin">
                        <!-- image -->
                        <img class="img-fluid rounded" src="{{url('assets/img/about/about2.jpg')}}" alt="">
                        <!-- ornament starts-->
                ...
                <div class="row">
                    ...
                    <div class="carousel-2items owl-carousel owl-theme col-md-12">
                        ...
                        <div class="testimonial">
                            <div class="content">
                            <p class="description">
                                @php echo $value->testDesc; @endphp
                            </p>
                            </div>
                            <!-- /content -->
                            <div class="testimonial-pic">
                            <img src="{{url('testiImage/'.$value->testiImage)}}" class="img-fluid" alt="">
                            </div>
                            <!-- /testimonial-pic -->
                            <div class="testimonial-review">
                            <h5 class="testimonial-title">{{$value->parentName}}</h5>
                            <span class="post">Parents</span>
                            </div>
                            <!-- /testimonial-review -->
                        </div>
                        <!-- /testimonial -->
                ...
                <!-- whale -->
                <img src="{{url('/assets/img/ornaments/whale.png')}}" class="floating-whale" alt="">
                <!-- waves -->
            ...
            <section id="features" class="bg-secondary text-light">
                ...
                <div class="row ">
                    ...
                    <div class="col-lg-6 features-bg">
                        <!-- image -->
                        <img src="{{url('assets/img/features.png')}}" alt="" class="img-fluid"  data-aos="zoom-out"   data-aos-delay="300"/>
                    </div>
                    <!-- /col-l -->
                </div>
                <!-- /row -->
                        ...
                        <div class="tabs-with-icon">
                            ...
                            <div class="tab-pane active" id="tab1" role="tabpanel" aria-labelledby="tab1-tab">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <!-- image -->
                                        <img src="{{url('assets/img/services/service1.jpg')}}" alt="" class="rounded img-fluid">
                                        <!-- ornament starts-->
                            ...
                            <div class="tab-pane" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 res-margin">
                                        <!-- image -->
                                        <img src="{{url('assets/img/services/service2.jpg')}}" alt="" class="rounded img-fluid">
                                        <!-- ornament starts-->
                            ...
                            <div class="tab-pane" id="tab3" role="tabpanel" aria-labelledby="tab3-tab">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <!-- image -->
                                        <img src="{{url('assets/img/services/service3.jpg')}}" alt="" class="rounded img-fluid">
                                        <!-- ornament starts-->
                            ...
                            <div class="tab-pane" id="tab4" role="tabpanel" aria-labelledby="tab4-tab">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 res-margin">
                                        <!-- image -->
                                        <img src="{{url('assets/img/services/service4.jpg')}}" alt="" class="rounded img-fluid">
                                        <!-- ornament starts-->
                                        <div class="ornament-stars" data-aos="fade-right"></div>
                                    </div>
                                    <!-- col-lg -->
                            ...
                            <div class="tab-pane" id="tab5" role="tabpanel" aria-labelledby="tab5-tab">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <!-- image -->
                                        <img src="{{url('assets/img/services/service5.jpg')}}" alt="" class="rounded img-fluid">
                                        <!-- ornament starts-->
                                        <div class="ornament-rainbow" data-aos="fade-right"></div>
                                    </div>
                                    <!-- col-lg -->
            ...
            <section id="team-home" class="container">
                ...
                <!-- /col-lg-->
                <div class="col-lg-5 res-margin">
                    <img src="{{url('assets/img/team/team-home')}}.jpg" alt="" class="img-fluid blob2">
                    <!-- ornament starts-->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="carousel-3items owl-carousel owl-theme mt-5 col-md-12">
                        <!-- Team member 1 -->
                        @if($getTeacherList)
                        @foreach($getTeacherList as $value)
                        <div class="col-lg-12 team-style3 bg-secondary pattern2">
                            <!-- image -->
                                <img src="{{url('teacherImage/'.$value->teacherImage)}}" class="img-fluid rounded" alt="" />
                            <!-- caption -->
                            <div class="team-caption">
                                <h4>{{$value->teacherHead}}</h4>
                                <h6>Teacher</h6>
                                <p>
                                @php
                                echo substr($value->testDesc,0,100);
                                @endphp
                                </p>
                            </div>
                            <!-- social icons -->
                ...
                <div class="carousel-3items owl-carousel owl-theme mt-0">
                    ...
                    <div class="blog-box">
                        ...
                        <div class="blog-box-caption">
                            <!-- date -->
                            <div class="date"><span class="day">{{date("d F", strtotime($value->blogDate));}}</span></div>
                            <a href="{{url('blog-details/'.$value->blogId)}}">
                        ...
                        <div class="blog-box-footer">
                            ...
                            <div class="comments"><a href="{{url('blog-details/'.$value->blogId)}}"><i class="fas fa-comment"></i>23</a></div>
                            <!-- Button -->	 
            ...
            <section id="callout" class=" container-fluid bg-fixed">
                ...
                <div class="row">
                    <div class="col-lg-6 p-0" data-start="right: 50%;" 
                        data-center="right:-5%;">
                        <!-- image  -->
                        <img src="{{url('assets/img/call-to-action')}}/calltoactionbg.jpg" class="img-fluid img-rounded" alt="">
                    </div>
                    <!-- text box  -->
                        ...
                        <div class="col-lg-7">
                            ...
                            <form action="contactme" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="submit" id="submit_btn" name="submit" value="Submit" class="btn btn-tertiary">Send message</button>
                                </div>
                            </form>
                            <!-- /form-group-->
                            <!-- Contact results -->
