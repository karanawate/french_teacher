    ...
    <body id="top">
        ...
        <div id="page-wrapper">
            <div class="register-lead-desktop">
                <form id="log" method="POST" action="">
                    <div class="form-group mt-3">
                        <input type="text" class="form-control" id="" placeholder="Enter Name of Your Child">
                    </div>
            ...
            <div class="register-lead-mobile">
                <form id="log" method="POST" action="">
                    <div class="form-group mt-3">
                        <input type="text" class="form-control" id="" placeholder="Enter Name of Your Child" required>
                    </div>
                    <div class="form-group">
                ...
                <div class="col-lg-4" data-aos="zoom-out">
                    <div class="card card-flip">
                        ...
                        <div class="card bg-secondary text-light ">
                            ...
                            <!-- /p-5 -->
                            <!-- image -->
                            <img class="card-img" src="/assets/img/intro1.jpg" alt="">
                        </div>
                        <!-- /card -->
                        <!-- back of card -->  			
                ...
                <div class="col-lg-4" data-aos="zoom-out" data-aos-delay="300">
                    <div class="card card-flip ">
                        ...
                        <div class="card bg-primary text-light">
                            ...
                            <!-- /p-5 -->
                            <!-- image -->
                            <img class="card-img" src="/assets/img/intro2.jpg" alt="">
                        </div>
                        <!-- /card -->
                        <!-- back of card -->  			
                ...
                <div class="col-lg-4" data-aos="zoom-out" data-aos-delay="600">
                    <div class="card card-flip ">
                        ...
                        <div class="card bg-tertiary text-light">
                            ...
                            <!-- /p-5 -->
                            <!-- image -->
                            <img class="card-img" src="/assets/img/intro3.jpg" alt="">
                        </div>
                        <!-- /card -->
                        <!-- back of card -->  			
            ...
            <section id="about-home" class="container-fluid pb-0">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 res-margin">
                        <!-- image -->
                        <img class="img-fluid rounded" src="/assets/img/about/about2.jpg" alt="">
                        <!-- ornament starts-->
                ...
                <!-- whale -->
                <img src="/assets/img/ornaments/whale.png" class="floating-whale" alt="">
                <!-- waves -->
            ...
            <section id="features" class="bg-secondary text-light">
                ...
                <div class="row ">
                    ...
                    <div class="col-lg-6 features-bg">
                        <!-- image -->
                        <img src="/assets/img/features.png" alt="" class="img-fluid"  data-aos="zoom-out"   data-aos-delay="300"/>
                    </div>
                    <!-- /col-l -->
                </div>
                <!-- /row -->
                        ...
                        <div class="tabs-with-icon">
                            ...
                            <div class="tab-pane active" id="tab1" role="tabpanel" aria-labelledby="tab1-tab">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <!-- image -->
                                        <img src="/assets/img/services/service1.jpg" alt="" class="rounded img-fluid">
                                        <!-- ornament starts-->
                            ...
                            <div class="tab-pane" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 res-margin">
                                        <!-- image -->
                                        <img src="/assets/img/services/service2.jpg" alt="" class="rounded img-fluid">
                                        <!-- ornament starts-->
                            ...
                            <div class="tab-pane" id="tab3" role="tabpanel" aria-labelledby="tab3-tab">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <!-- image -->
                                        <img src="/assets/img/services/service3.jpg" alt="" class="rounded img-fluid">
                                        <!-- ornament starts-->
                            ...
                            <div class="tab-pane" id="tab4" role="tabpanel" aria-labelledby="tab4-tab">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 res-margin">
                                        <!-- image -->
                                        <img src="/assets/img/services/service4.jpg" alt="" class="rounded img-fluid">
                                        <!-- ornament starts-->
                                        <div class="ornament-stars" data-aos="fade-right"></div>
                                    </div>
                                    <!-- col-lg -->
                            ...
                            <div class="tab-pane" id="tab5" role="tabpanel" aria-labelledby="tab5-tab">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <!-- image -->
                                        <img src="/assets/img/services/service5.jpg" alt="" class="rounded img-fluid">
                                        <!-- ornament starts-->
                                        <div class="ornament-rainbow" data-aos="fade-right"></div>
                                    </div>
                                    <!-- col-lg -->
            ...
            <section id="team-home" class="container">
                ...
                <!-- /col-lg-->
                <div class="col-lg-5 res-margin">
                    <img src="/assets/img/team/team-home.jpg" alt="" class="img-fluid blob2">
                    <!-- ornament starts-->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="carousel-3items owl-carousel owl-theme mt-5 col-md-12">
                        ...
                        <div class="col-lg-12 team-style3 bg-secondary pattern2">
                            <!-- image -->
                                <img src="/assets/img/team/team1.jpg" class="img-fluid rounded" alt="" />
                            <!-- caption -->
                            <div class="team-caption">
                                <h4>Laura Smith</h4>
                                <h6>Teacher</h6>
                                <p>Incidunt accusamus necessitatibus modi adipisci officia libero accusantium esse hic, obcaecati, ullam, laboriosa    </p>
                            </div>
                            <!-- social icons -->
                        ...
                        <div class="col-lg-12 team-style3 bg-secondary pattern2">
                            <!-- image -->
                            <img src="/assets/img/team/team2.jpg" class="img-fluid rounded" alt="" />
                            <!-- caption -->
                            <div class="team-caption">
                                <a href="">
                                <h4>John Doe</h4>
                        ...
                        <div class="col-lg-12 team-style3 bg-secondary pattern2">
                            <!-- image -->
                            <img src="/assets/img/team/team3.jpg" class="img-fluid rounded" alt="" />
                            <!-- caption -->
                            <div class="team-caption">
                        ...
                        <div class="col-lg-12 team-style3 bg-secondary pattern2">
                            <!-- image -->
                            <img src="/assets/img/team/team4.jpg" class="img-fluid rounded" alt="" />
                            <!-- caption -->
                            <div class="team-caption">
                                <a href="team-single.html">
                                <h4>Mika Doe</h4>
                        ...
                        <div class="col-lg-12 team-style3 bg-secondary pattern2">
                            <!-- image -->
                            <img src="/assets/img/team/team5.jpg" class="img-fluid rounded" alt="" />
                            <!-- caption -->
                            <div class="team-caption">
                                <a href="team-single.html">
                                <h4>Jillian Smith</h4>
                ...
                <div class="carousel-3items owl-carousel owl-theme mt-0">
                    ...
                    <div class="blog-box">
                        ...
                        <a href="blog-single.html">
                            <div class="image"><img src="/assets/img/blog/blogstyle2-1.jpg" alt=""/></div>
                        </a>
                        <!-- blog-box-caption -->
                    ...
                    <div class="blog-box">
                        <!-- image -->
                        <a href="blog-single.html">
                            <div class="image"><img src="/assets/img/blog/blogstyle2-2.jpg" alt=""/></div>
                        </a>
                        <!-- blog-box-caption -->
                        <div class="blog-box-caption">
                            <!-- date -->
                    ...
                    <div class="blog-box">
                        <!-- image -->
                        <a href="blog-single.html">
                            <div class="image"><img src="/assets/img/blog/blogstyle2-3.jpg" alt=""/></div>
                        </a>
                        <!-- blog-box-caption -->
                        <div class="blog-box-caption">
                            <!-- date -->
                    ...
                    <div class="blog-box">
                        <!-- image -->
                        <a href="blog-single.html">
                            <div class="image"><img src="/assets/img/blog/blogstyle2-4.jpg" alt=""/></div>
                        </a>
                        <!-- blog-box-caption -->
                        <div class="blog-box-caption">
                            <!-- date -->
            ...
            <section id="callout" class=" container-fluid bg-fixed">
                ...
                <div class="row">
                    <div class="col-lg-6 p-0" data-start="right: 50%;" 
                        data-center="right:-5%;">
                        <!-- image  -->
                        <img src="/assets/img/call-to-action/calltoactionbg.jpg" class="img-fluid img-rounded" alt="">
                    </div>
                    <!-- text box  -->
