						...
						<div class="card border-top border-0 border-4 border-danger">
							<div class="card-body p-5">
								<div class="card-title d-flex align-items-center">
									...
									<h5 class="mb-0 text-danger">Edit Assigment</h5>
								</div>
								<hr>
								<div class="col-md-12">
									...
									@endif
								<form class="row g-3" action="{{route('assigments.update', $assigment->Assigment_Id )}}" method="post" enctype= multipart/form-data >
								@csrf
								@method('PATCH')
								<input type="hidden" value="{{ $assigment->allocated_file }}" name="Old_image"  />
										 <div class="row">
												<div class="col-md-6">
													<label for="inputLastName1" class="form-label">Enter Title</label>
													<div class="input-group"> 
														<input type="text" name="home_title"  class="form-control"  value="{{ $assigment->home_title }}" />
													</div>
										...
										<div class="row">
												<div class="col-md-6">
													...
													<div class="input-group"> 
														<input type="date" name="start_time" class="form-control" id="" value="{{ $assigment->start_time}}" placeholder="Enter parentName" />
													</div>
										...
										<div class="row">
												<div class="col-md-6">
													<label for="inputLastName1" class="form-label">Start time</label>
													<div class="input-group"> 
														<input type="date" name="end_time" value="{{ $assigment->start_time}}"  class="form-control" />
													</div>
													<span style="color:red">@error('start_time'){{ $message }}@enderror</span>
												</div>
										</div>
										<div class="row">
												<div class="col-md-6">
														...
														<textarea name="description" rows="10" cols="80" value="{{ $assigment->assigment }}" >{{ $assigment->assigment }}</textarea>
														</div>
